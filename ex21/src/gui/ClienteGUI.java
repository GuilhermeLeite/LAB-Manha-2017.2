...
public class ClienteGUI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGap(131, 131, 131)
                .addComponent(novoBT, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void novoBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_novoBTActionPerformed
        ...
        lista = arq.lerArquivo(f);
        limpar();
        int id=BufferCliente.idNovoUsuario(lista);
        c = new Cliente(id);
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        ...
        if (arq.novoDado(arquivo, c.toString())) {
            ...
            JOptionPane.showMessageDialog(this, "Salvo fail", "Novo usuario", JOptionPane.ERROR_MESSAGE);
        }
        preencherTabela();
